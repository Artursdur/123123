...
void CreateStaticStorage()
{
	...
	{
		"банка 2л", "банка 1.5л", "крышка банки", "Кальян из банки", "Табак MustHalf для кольяна из банки", "Энергетик non stop", "Фольга для банки",
		"железные банки", "Клей - момент для банок", "Пакет с мерчем банок"
	};
